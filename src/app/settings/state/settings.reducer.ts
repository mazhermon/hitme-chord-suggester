...
//selectors
const getSettingsFeatureState = createFeatureSelector<UserSettingState>(
  "userSettings"
);

export const getKeysData = createSelector(
  getSettingsFeatureState,
  state => state && state.keysData
);

export const getGlobalKeyName = createSelector(
  getSettingsFeatureState,
  state => state && state.globalKeyCentre.name
);

export const getGlobalKeyQuality = createSelector(
  getSettingsFeatureState,
  state => state && state.globalKeyCentre.quality
);

export const getGlobalKeyCenter = createSelector(
  getSettingsFeatureState,
  state => state && state.globalKeyCentre
);
